(function () {
	...
	const DEFAULT_WIDGET_BUTTON = { widgetButton: { backgroundColor: "#7351dd", textColor: "#fff", zIndex: 10000, buttonText: "Ask AI" } };
	const ICON_SVG = `
  ...
  `;
	...
	function buildIframeUrl() {
		...
		if (config.user) {
			const userObject = { fullName: config.user.name, emailAddress: config.user.email, mobilePhone: config.user.phoneNumber };
	...
	function initWidget(userConfig) {
		...
		config = { ...DEFAULT_WIDGET_BUTTON, ...userConfig };
		destroyWidget();
