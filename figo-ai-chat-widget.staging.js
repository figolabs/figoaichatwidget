(function () {
	...
	function initWidget(userConfig) {
		...
		iframeContainer.style.cssText = isCenter
			? `position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 700px; height: 700px; background: white; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15); display: none; z-index: 999; border-radius: 12px;`
